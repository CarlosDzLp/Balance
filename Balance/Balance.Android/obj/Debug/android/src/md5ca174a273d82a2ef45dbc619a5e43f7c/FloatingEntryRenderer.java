...
public class FloatingEntryRenderer
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Balance.Droid.Controls.FloatingEntryRenderer, Balance.Android", FloatingEntryRenderer.class, __md_methods);
	}


	public FloatingEntryRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == FloatingEntryRenderer.class)
			mono.android.TypeManager.Activate ("Balance.Droid.Controls.FloatingEntryRenderer, Balance.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public FloatingEntryRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == FloatingEntryRenderer.class)
			mono.android.TypeManager.Activate ("Balance.Droid.Controls.FloatingEntryRenderer, Balance.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public FloatingEntryRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == FloatingEntryRenderer.class)
			mono.android.TypeManager.Activate ("Balance.Droid.Controls.FloatingEntryRenderer, Balance.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
